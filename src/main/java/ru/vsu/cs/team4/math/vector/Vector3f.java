package ru.vsu.cs.team4.math.vector;
...
public class Vector3f implements Vector<Vector3f> {
    ...
    public static Vector3f sub(Vector3f v, float num) {
        return new Vector3f(v.x - num, v.y - num, v.z - num);
    }
    ...
    @Override
    public float scalarMul(Vector3f v) {
    ...
    public static Vector3f vectorMul(Vector3f v1, Vector3f v2) {
